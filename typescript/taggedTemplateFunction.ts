...
const gitHub = `\t\t<svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} fill={color} class="bi bi-github" viewBox="0 0 16 16">
...
│                                                                                                  │
│     return (                                                                                     │
│         <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} fill={color} class="b │
│ i bi-github" viewBox="0 0 16 16">                                                                │
